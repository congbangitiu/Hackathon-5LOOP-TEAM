...
const Author = () => {
  ...
  const authorDetailsData = AuthorData.filter(
    (item) => item.username === authorUsername
  );
  const authorItemsData = DiscoverNFTData.filter(
    (item) => item.authorName === authorUsername
  );
      ...
      >
        <div className="container">
          <div className="card border-0 bg-transparent">
            ...
            {/* Copy Link */}
            <CopyLink show={modalShow2} onHide={() => setModalShow2(false)} />
            ...
            <div className="col-12 col-lg-8">
              <div className="row g-4 align-items-center justify-content-between">
                <div className="col-12 col-sm-6">
                  <select
                    ref={selectSortBy}
                    className="filter-select bg-gray w-100"
                  >
