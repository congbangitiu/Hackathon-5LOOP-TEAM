      ...
      <div className="card text-center">
        <div className="card-body">
          <Link className="d-block" to={elem.demoURL}>
            <img
              className="rounded"
              src={`${process.env.PUBLIC_URL}/${elem.demoImage}`}
              alt={elem.name}
            />
          </Link>
          <h5 className="mb-0 mt-3">{elem.name}</h5>
        </div>
      </div>
    </div>
  ));
    ...
    <div className="demo-page-wrapper">
      ...
      <div className="container">
        <div className="filters-button-group text-center mb-70">
          ...
          >
            All Pages
            <span className="badge bg-warning text-dark rounded-pill ms-1 lh-1">
              35
            </span>
          </button>
        ...
        <div className="row g-4 justify-content-center">{demoCards}</div>
      </div>
    </div>
  );
}
