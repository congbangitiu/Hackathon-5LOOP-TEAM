        ...
        <div className="row justify-content-center">
          <div className="col-10">
            <div className="text-center">
              <h1 className="display-5 fw-bold mb-4">{data.title}</h1>
              ...
              <ol className="ps-0 list-unstyled">
                ...
                <li className="single-comment">
                  <div className="comment-content d-flex">
                    <div className="comment-author">
                      <img
                        src={`${process.env.PUBLIC_URL}/img/bg-img/u4.jpg`}
                        alt="author"
                      />
                    </div>
                  ...
                  <ol className="children list-unstyled">
                    ...
                    <li className="single-comment">
                      <div className="comment-content d-flex">
                        <div className="comment-author">
                          <img
                            src={`${process.env.PUBLIC_URL}/img/bg-img/u2.jpg`}
                            alt="author"
                          />
                        </div>
                        <div className="comment-meta">
                ...
                <li className="single-comment">
                  <div className="comment-content d-flex">
                    <div className="comment-author">
                      <img
                        src={`${process.env.PUBLIC_URL}/img/bg-img/u3.jpg`}
                        alt="author"
                      />
                    </div>
                    <div className="comment-meta">
