...
const FeaturedNFTDetails = () => {
  ...
  const featuredDetailsData = FeaturedNFTData.filter(
          ...
          <div className="row g-4 g-lg-5 align-items-center justify-content-center">
            ...
            <div className="col-12 col-md-12 col-lg-6">
              <div className="item-big-thumb">
                ...
                >
                  <img
                    src={`${process.env.PUBLIC_URL}/${featuredData.image}`}
            ...
            <div className="col-12 col-md-9 col-lg-6">
              <div className="item-details-content mt-5 mt-lg-0">
                ...
                {/* Dropdown */}
                <Dropdown
                  className={`section-${featuredData.dropdownVisibility} item-details-dd`}
                >
                  <Dropdown.Toggle
                    className="rounded-pill shadow-sm p-0"
                    id={`featuredDetailsID${featuredData.id}`}
                  >
                    <i className="bi bi-three-dots-vertical" />
                  </Dropdown.Toggle>
                ...
                <div className="d-flex flex-wrap align-items-center">
                  ...
                  >
                    <i className="bi" />
                    <span className="ms-1">{featuredData.wishlistCount}</span>
                  </button>
                ...
                {/* Title */}
                <h2 className="my-3">{featuredData.title}</h2>
                ...
                <div className="d-flex align-items-center mb-4">
                  ...
                  <div className="author-img position-relative me-3">
                    ...
                    />
                    <i
                      className={`bi bi-check position-absolute bg-primary ${featuredData.authorVerified}`}
                    />
                  </div>
                ...
                <div className="row align-items-end">
                  ...
                  <div className="col-6 col-sm-4 col-lg-5">
                    <Link
                      className={`btn btn-${featuredData.buttonGroup[0].leftButtonStyle} rounded-pill w-100`}
                      to={featuredData.buttonGroup[0].leftButtonURL}
                    >
                      <img
                        className="me-1"
                ...
                <div className="short-description">
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{
                      __html: featuredData.shortDesc[0].body,
                    }}
                  ></p>
                </div>
              </div>
